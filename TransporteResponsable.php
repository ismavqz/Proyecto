<?php
	...
	//se reciben los datos de transporte usuario
	if (isset($_SESSION["Tipo_usuario"]) == "Responsable") {
...
<body>
	...
	<form method="post" id="frm">
		<table class="table1">
				...
				<td><input type="submit" id="Botton" name="comprobar" value="APROBAR" ></td>
				<td></td>
				<td><input type="submit" id="Botton" name="enviar" value="RECHAZAR"></td>
				<td></td>
				</table>
	</form>
</body>
