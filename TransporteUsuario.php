<?php
	...
	if (isset($_POST['btn'])) {
		...
		$_SESSION['Area'] = $_POST['txtAreaAds'];
...
<body>
	...
	<form method="post" id="frm">
		<table class="table1">
					...
					<tr>
						<td >NOMBRE: </td><td ><input type="text" id="nombre" name="nombre" placeholder="Nombre de Solicitante"  onkeypress="return soloLetras(event)" value="" required></td>
						<td >FOLIO: </td><td ><input type="text" id="Folio" name="Folio" placeholder="Folio" onkeypress="return soloNumeros(event)" value="" required></td>
					</tr>
					<tr>
						<td >DEPTO O ÁREA DE ADSCRIPCIÓN: </td>
						<td><input type="text" class="anch" id="txtAreaAds" name="txtAreaAds" placeholder="Depto a Area de Ads" onkeypress="return soloLetras(event)" required></td>
						
						<td>FECHA DE SOLICITUD: </td>
						<td><input type="date" id="Fecha" name="FechaSoli" min="DD/MM/AAAA" required></td>
					</tr>
					...
					<tr>
						<td ><textarea rows="3"  name="OrigenIda" required></textarea></td>
						<td ><textarea rows="3"  name="DestinoIda" required></textarea></td>
						<td ><textarea rows="3"  name="OrigenReg" required></textarea></td>
						<td ><textarea rows="3"  name="DestinoReg" required></textarea></td>	
					</tr>

					<tr>
						<td >FECHA DE SALIDA: </td><td><input type="date" class="anch" name="FechaSalida" required></td>
						<td >FECHA LLEGADA: </td><td ><input type="date" class="anch" name="FechaRegreso" required></td>
					</tr>
					...
					<tr>
						<td >NÚMERO DE PASAJEROS: </td><td><input type="text" class="anch" name="NumPasajIda" onkeypress="return soloNumeros(event)" required></td>
						<td >NÚMERO DE PASAJEROS: </td><td><input type="text" class="anch" name="NumPasajReg" onkeypress="return soloNumeros(event)" required></td>
					</tr>
					...
					<tr>	
						<td><textarea rows="3"  name="KmIda" required></textarea></td>
						
						<td><textarea rows="3"  name="CombusIda" required></textarea></td>
						
						<td><textarea rows="3"  name="Kmregreso" required></textarea></td>

						<td><textarea rows="3"  name="CombusReg" required></textarea></td>	
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="Solicitante" class="firma1" onkeypress="return soloLetras(event)" required>
						</td>
						<td colspan="2" >
							<input type="text" name="JefeResp" class="firma1" onkeypress="return soloLetras(event)" required>
						</td>
						<td>
							<input type="text" name="DepAdministrativo" class="firma1" onkeypress="return soloLetras(event)" required>
						</td>
					</tr>
				...
				<td></td>
				<td colspan="2"><input type="submit" id="Botton" name="btn" value="ENVIAR" ></td>
				<td></td>		
				</table>
