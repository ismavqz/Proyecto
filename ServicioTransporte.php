...
<body>
	...
	<form method="post" id="frm">
		<table class="table1">
					...
					<tr>
						<td >NOMBRE: </td><td ><input type="text" id="nombre" name="nombre" placeholder="Nombre de Solicitante"  onkeypress="return soloLetras(event)" required></td>
						<td >FOLIO: </td><td ><input type="text" id="Folio" name="Folio" placeholder="Folio" onkeypress="return soloNumeros(event)" required></td>
					</tr>
					<tr>
						<td >DEPTO O ÁREA DE ADSCRIPCIÓN: </td><td ><input type="text" class="anch" id="txtAreaAds" name="txtAreaAds" placeholder="Depto a Area de Ads" onkeypress="return soloLetras(event)" required></td>
						<td >FECHA DE SOLICITUD: </td><td><input type="date" id="Fecha" name="FechaSoli" min="DD/MM/AAAA" required></td>
					</tr>
